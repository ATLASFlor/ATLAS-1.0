...
MODULE Master
  ...
  !
  real(rp)    :: d_trop  = 50. !according Stohl et al 2005
  real(rp)    :: d_strat = 0.1! According Legras et al 2003
  ...
  type particles
     !
     integer(ip):: state   ! 1:active, 0:still not out, -1: sedimented in the domain, -2:outside the domain
  ...
  type source_phases
     ...
     !
     integer  (ip)                          :: np,ng,mdist           ! .type distribution. 
