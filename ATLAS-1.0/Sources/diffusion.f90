subroutine diffusion(ugrid,vgrid,wgrid,z,pblha,rmonin,usta,wst,drhodz,rhoa,lon,lat,ux,vy,wp)
  !******************************************************************************************
...
! 										       *
!*** Inputs: 									       *
!           pblh pbl height at particle position				       *
!           rmonin   monin obukhov lenght at particle position			       *
!           z        particle height						       *
