...
CONTAINS
  ...
  subroutine solvesuzuki(iphase,part1,part2)
    ...
    ! Divide total mass in particles groups, according their particle class and mass fraction.
...
!    integer (ip) :: ibinstart,ibinend      ! ibin corresponding to the part1 and part2 respectively
    ...
    write(ext5,*) MFR
    write(lulog,5) 'The mass erupted, sum of all particle in the present range, is'//ext5// 'kg'
5   format(/,  a /)
    !
    !
